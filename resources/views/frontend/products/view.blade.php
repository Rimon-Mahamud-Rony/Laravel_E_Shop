...
@section('content')
    ...
    <div class="py-3 mb-4 shadow-sm bg-info border-top">
        <div class="container">
            <h6 class="mb-0"> Collection / <span> <a href="{{url('view_category/'.$products->call_catagory_data->name)}}" style="color:white;">{{$products->call_catagory_data->name}}</a> </span>/  {{$products->name}} </h6>
        </div>
    </div>
